...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { descripccion: @agenda.descripccion, fecha: @agenda.fecha, prioridad: @agenda.prioridad, tarea: @agenda.tarea }
    end
  ...
  test "should update agenda" do
    patch :update, id: @agenda, agenda: { descripccion: @agenda.descripccion, fecha: @agenda.fecha, prioridad: @agenda.prioridad, tarea: @agenda.tarea }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
